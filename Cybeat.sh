...
wget https://raw.githubusercontent.com/Cybeat110814/Cybeat/master/Cybeat/vpn-server.sh --no-check-certificate
...
echo Please dont forget to say thanks to: Cybeat
echo ---------------------------------------------
#End of script
